...
// Create or reuse a persistent user ID and save under both keys for compatibility
useEffect(() => {
...
// Also save legacy key to be compatible with older code that reads "user"
localStorage.setItem("user", user);
} else {
// Ensure legacy key exists (keeps older components working)
...
> <div className="profile"> <img
         ...
         alt="Stacks Logo"
         className="avatar"
       /> <div className="profile-text"> <h4>Stacks-CS</h4> <span>Customer Service</span> </div> </div>
